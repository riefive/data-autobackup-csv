...
class Questions {
    ...
    folder() {
        let folderValue = _.has(this.config, 'folder') ? this.config.backup : 'backup';

        return [{
            type: 'confirm',
            name: 'isfolder',
            message: 'Ingin mengatur kembali konfigurasi nama folder backup?',
            default: false
        }, {
            type: 'input',
            name: 'folder',
            message: 'Nama lokasi folder backup?',
            default: folderValue,
